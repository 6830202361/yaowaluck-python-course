...
เขียนโปรแกรมค่านวณค่าไฟฟ้าจากจำนวนหน่วยไฟฟ้าที่ใช้ในเดือนนั้น โดยใช้ฟังก์ชัน
...
เงื่อนไข
    ...
    ผู้ใช้เลือก 1 เพื่อค่านวณค่าไฟ
    ผู้ใช้เลือก 2 เพื่อออกจากโปรแกรม
    หากเลือกเมนูอื่น ให้แจ้งว่าเลือกเมนูไม่ถูกต้อ'
    จำนวนหน่วยไฟฟ้าต้องไม่ติดล[
...
if units > 200:
    ...
    print(f”201-{units} หน่วย: {(units - 200) * 4.003 บาท”)  
